module ProjectYaML
  module Persist
    # In-memory version of {ProjectYaML::Persist::PluginInterface}
    # used by {ProjectYaML::Persist::Controller} when ':memory' is the 'persist_mode'
    # in ProjectYaML configuration
