...
require 'project_yaml/persist/controller'

require "yaml"
require "singleton"

# This class is the interface to all querying and saving of objects for ProjectYaML
module ProjectYaML
  class Data
    include Singleton
    ...
    # {ProjectYaML::Config::Server} object for {ProjectYaML::Data}
    # {ProjectYaML::Controller} object for {ProjectYaML::Data}
    attr_accessor :persist_ctrl

    # Initializes our {ProjectYaML::Data} object
    #  Attempts to load {ProjectYaML::Configuration} and initialize {ProjectYaML::Persist::Controller}
    def initialize
    ...
    # Called when work with {ProjectYaML::Data} is complete
    def teardown
    ...
    # Takes an {ProjectYaML::Object} and creates/persists it within the database.
    # @note If {ProjectYaML::Object} already exists it is simply updated
    #
    # @param [ProjectYaML::Object, Array] object
    # @return [ProjectProjectYaML::Object] returned object is a copy of passed {ProjectYaML::Object} with bindings enabled for {ProjectYaML::ProjectYaML#refresh_self} and {ProjectYaML::ProjectYaML#update_self}
    def persist_object(object, options = {})
      if object.class == Array
        ...
        unless options[:multi_collection]
          raise ProjectYaML::Error::MissingMultiCollectionOnGroupPersist, "Missing namespace on multiple object  persist"
        end
    ...
    # Removes all {ProjectYaML::Object}'s that exist in the collection name given
    #
    ...
    # Removes specific {ProjectYaML::Object} that exist in the collection name given
    #
    # @param [ProjectProjectYaML::Object] object The {ProjectYaML::Object} to delete
    # @return [true, false]
    ...
    # Removes specific {ProjectYaML::Object} that exist in the collection name with given 'uuid'
    #
    # @param [Symbol] object_symbol The name of the collection
    # @param [String] object_uuid The 'uuid' of the {ProjectYaML::Object}
    # @return [true, false]
    ...
    # Takes a [Hash] from a {ProjectYaML::Persist:Controller} document and converts back into an {ProjectYaML::Object}
    # @api private
    # @param [Hash] object_hash The hash of the object
    # @return [ProjectYaML::Object, ProjectYaML]
    ...
    # Initiates the {ProjectYaML::Persist::Controller} for {ProjectYaML::Data}
    # @api private
    #
    # @return [ProjectYaML::Persist::Controller, ProjectYaML]
    def setup_persist
      logger.debug "Persist controller init"
      @persist_ctrl = ProjectYaML::Persist::Controller.new
    end
