...
require "project_yaml/error/generic"
require "require_all"
...
module ProjectYaML
  module Error
    ...
    def self.create_class(new_class, error_code, val={}, msg='', parent_str='ProjectYaML::Error::Generic')
      ...
      parent = ProjectYaML::Error.contantize(parent_str)
      parent_module_str = parent_str.split('::')[0..-2].join('::')
      parent_module = ProjectYaML::Error.contantize(parent_module_str)
    ...
    [
        [ 'CannotCreatePolicyTable'                , 10 , {'@http_err' => :bad_request}            , ''          , 'ProjectYaML::Error::Generic' ],
        [ 'MissingMultiCollectionOnGroupPersist'   , 31 , {'@http_err' => :internal_server_error}  , ''          , 'ProjectYaML::Error::Generic' ],
    ].each do |err|
